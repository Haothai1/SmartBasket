...
namespace    // unnamed, anonymous namespace
{
  ...
  constexpr bool floating_point_is_equal( T const lhs,  U const rhs,  double const EPSILON = 1e-4 ) noexcept
  {
    ///////////////////////// TO-DO (1) //////////////////////////////
      ...
      ///         do this instead:
      ///           return a < b;
      return std::abs( lhs - rhs ) < EPSILON;    // compare floating point values
...
///////////////////////// TO-DO (2) //////////////////////////////
  /// Copying the parameters into the object's attributes (member variables) "works" but is not correct.  Be sure to move the parameters into the object's attributes
    : _upcCode{ std::move( upcCode ) },    // initialization list set to default values
...
///////////////////////// TO-DO (3) //////////////////////////////
  : _upcCode{ other._upcCode },    // initialization list to copy variables
...
///////////////////////// TO-DO (4) //////////////////////////////
  : _upcCode{ std::move( other._upcCode ) },    //  moves data from object to another object
...
if( this != &rhs )
{
  // copies all rhs values to lhs variables
...
///////////////////////// TO-DO (6) //////////////////////////////
{
  if( this != &rhs )
  {
    _upcCode     = std::move( rhs._upcCode );    // moves data to new object
...
{
  ///////////////////////// TO-DO (8) //////////////////////////////
    return _upcCode;    // used to access _upCode data
  /////////////////////// END-TO-DO (8) ////////////////////////////
}
...
{
  ///////////////////////// TO-DO (9) //////////////////////////////
    return _brandName;    // used to access _brandName data
  /////////////////////// END-TO-DO (9) ////////////////////////////
}
...
{
  ///////////////////////// TO-DO (10) //////////////////////////////
    return _productName;    // used to access _productName data
  /////////////////////// END-TO-DO (10) ////////////////////////////
}
...
{
  ///////////////////////// TO-DO (11) //////////////////////////////
    return _price;    // used to access _price data
  /////////////////////// END-TO-DO (11) ////////////////////////////
}
...
{
  ///////////////////////// TO-DO (12) //////////////////////////////
    return std::move( _upcCode );    // moves data to new object and returns the value
  /////////////////////// END-TO-DO (12) ////////////////////////////
}
...
{
  ///////////////////////// TO-DO (13) //////////////////////////////
    return std::move( _brandName );    // moves data to new object and returns the value
  /////////////////////// END-TO-DO (13) ////////////////////////////
}
...
{
  ///////////////////////// TO-DO (14) //////////////////////////////
    return std::move( _productName );    // moves data to new object and returns the value
  /////////////////////// END-TO-DO (14) ////////////////////////////
}
...
std::weak_ordering GroceryItem::operator<=>( const GroceryItem & rhs ) const noexcept
{
  ...
  ///////////////////////// TO-DO (19) //////////////////////////////
  // compares the GroceryItem class's rhs and lhs values
  // if result is not equal to zero return the object
  ...
  // if result is equal return if not equal to 0
  if( floating_point_is_equal( _price, rhs._price ) ) return std::weak_ordering::equivalent;
  // if result is less return the greater one
...
bool GroceryItem::operator==( const GroceryItem & rhs ) const noexcept
{
  ...
  ///////////////////////// TO-DO (20) //////////////////////////////
  // checks if the GroceryItem class is equal to rhs class
...
std::istream & operator>>( std::istream & stream, GroceryItem & groceryItem )
{
  ///////////////////////// TO-DO (21) //////////////////////////////
    ...
    // declare a variable for GroceryItem
    GroceryItem itemSent;
    // declare a limiter
    char delimiter = '\0';

    // extract values from the input stream; stores class member variable and extracts the next char to store in dlimiter variable
    if( stream >> std::ws >> std::quoted( itemSent._upcCode ) && stream >> std::ws >> delimiter && delimiter == ',' &&
      stream >> std::ws >> std::quoted( itemSent._brandName ) && stream >> std::ws >> delimiter && delimiter == ',' && 
      stream >> std::ws >> std::quoted( itemSent._productName ) && stream >> std::ws >> delimiter && delimiter == ',' && 
      stream >> std::ws >> ( itemSent._price ) )
    {
      // if all values are extracted, assign the parameter for GroceryItem
      groceryItem = std::move( itemSent );
    }
    else
      // output error if info is not extracted properly
