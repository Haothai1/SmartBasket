...
int main()
{
  try
  {
    ...
    ///////////////////////// TO-DO (2) //////////////////////////////
      ...
      ///
      // make shopping carts for each customer
      GroceryStore::ShoppingCarts numCarts = superMarket.makeShoppingCarts();
    /////////////////////// END-TO-DO (2) ////////////////////////////
    ...
    ///////////////////////// TO-DO (3) //////////////////////////////
      ...
      ///
       ...
       // Process the shoppers by passing the collection of shopping carts to your store's ringUpCustomers function. 
      GroceryStore::GroceryItemsSold itemsBought = superMarket.ringUpCustomers(numCarts, std::cout);
    ...
    ///////////////////////// TO-DO (4) //////////////////////////////
      ...
      /// store's inventory.
      ///
      GroceryStore::Inventory_DB &inventory = superMarket.inventory(); //  a reference to your store's inventory by using your store's inventory function
      if(inventory.find("00041331092609") !=inventory.end()) {
              inventory.erase("00041331092609"); // remove Frozen Spanish Omelets
      }
    /////////////////////// END-TO-DO (4) ////////////////////////////
    ...
    ///////////////////////// TO-DO (5) //////////////////////////////
      ...
      superMarket.reorderItems(itemsBought); // reorder the items that were sold
